...
" Palette reference:
"   bg         = #1A1B1C   selection  = #31353A   comment    = #676B79
"   fg         = #E6E6E6   lime       = #A8F0A6   blue       = #6FC1FF
"   hot_pink   = #FF2C6D   pink       = #FF75B5   orange     = #FFB86C
"   lavender   = #BCAAFE   purple     = #B084EB
...
let s:N3 = [ '#676B79', '#1A1B1C', 244, 232        ]
...
let s:I3 = [ '#676B79', '#1A1B1C', 244, 232        ]
...
let s:V3 = [ '#676B79', '#1A1B1C', 244, 232        ]
...
let s:C3 = [ '#676B79', '#1A1B1C', 244, 232        ]
